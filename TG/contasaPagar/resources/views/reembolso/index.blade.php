                        ...
                        <tbody>
                            @foreach ($reembolsos as $reembolso)
                                <tr>
                                    ...
                                    @endif
                                    <td>@if($reembolso->status == 'A') Pendente @elseif($reembolso->status == 'P') Pago @else Recusado @endif</td>
                                    ...
                                    <td class="action-icons">
                                        @if(Auth::user()->tipo_usuario == 'G')
                                            @if($reembolso->status == 'A')
                                                <a href="{{ route('contas.pagar', ['id'=>$reembolso->id, 'redirect'=>'reembolso.index']) }}">
                                                    <i class="fas fa-money-bill-wave" data-toggle="tooltip" data-placement="top"
                                                        title="Pagar"></i>
                                                </a>

                                                <a href="{{ route('reembolso.recusar', ['id'=>$reembolso->id, 'redirect'=>'reembolso.index']) }}">
